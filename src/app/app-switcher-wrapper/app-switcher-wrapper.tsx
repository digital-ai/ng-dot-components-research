...
function AppSwitcherButton(
  { iconId = 'apps', tooltip = "Toggle app switcher" }: AppSwitcherButtonProps
) {
...
export class DotAppSwitcherWrapperComponent implements OnChanges, OnDestroy, AfterViewInit {
  ...
  @Input() public platformApi: string = 'https://demo-mock-api';
  @Input() public token: string = 'jwt; ignored for demo data';
  ...
  private render() {
    ReactDOM.render(
      <DotThemeProvider>
        <DotCoreApiProvider apiUrl={this.platformApi} token={this.token}>
